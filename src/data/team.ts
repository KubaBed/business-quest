// Wspólne zdjęcie founderek (na neutralnym tle) — kolejność od lewej: Joanna, Zuzanna, Marta.
export const teamPhoto = "/images/team/founders.webp";
...
export const team = [
  ...
  },
  {
    ...
    bio: "Psycholożka z wykształcenia, zawodowo HR-owiec z 10-letnim stażem, głównie w branży produkcyjnej. Prowadzi markę Growth Care, specjalizując się w rekrutacji, employer brandingu i komunikacji. Pasjonuje się społeczną odpowiedzialnością biznesu, pracuje jako asesorka i coach kariery (ICF). Współpracuje z biznesem, klientami indywidualnymi oraz NGO.",
  },
];
